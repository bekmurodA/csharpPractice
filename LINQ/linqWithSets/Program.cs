...
using System.Linq;	//for extension methods
...
namespace linqWithSets
{
	...
	//with Zip if there are unequal numbers of items in the sequence, 
	//those without partenrs will not be included in the result
	}
    }
}
